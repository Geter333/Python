...
# Запись данных в JSON файл с оберткой в объект
json_data = json.dumps({"students": students})
with open("students_grades.json", "wt") as file:
    file.write(json_data)

# Чтение данных из JSON файла с извлечением студентов из объекта
with open("students_grades.json", "rt") as file:
    data = json.loads(file.read())
    students = data["students"]

# Функция для обчислення середньої оцінки
